      ...
      <div className="max-w-container mx-auto px-6">
        <Reveal className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-3">
            <a target="_blank" href="https://www.instagram.com/proyakh008/?hl=en" className="social-icon w-9 h-9 rounded-full border border-[#111111]/10 flex items-center justify-center text-[#111111]/35">
...
<li className="text-sm text-[#111111]/35">
  <a href="tel:+916000244871" className="text-inherit no-underline">
    +91 60002 44871
              ...
              <li className="text-sm text-[#111111]/35">Guwahati, Assam, India</li>
            </ul>
          </Reveal>
        </div>

        <div className="text-center pt-8 max-w-3xl mx-auto space-y-1.5">
